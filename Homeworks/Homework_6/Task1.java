...
public class Task1 {
    public static void main(String[] args) throws FileNotFoundException {
        NotebookTask1 notebook = new NotebookTask1();
        notebook.readFile();
        Scanner iScanner = new Scanner(System.in);
        boolean flag = true;
        while (flag) {
            int choice = menu(iScanner);
            System.out.println();
            switch (choice) {
                case 1 -> notebook.printFile(notebook.notebooks);
                case 2 -> filtration(notebook, iScanner);
                case 0 -> {
                    flag = false;
    ...
    private static void filtration(NotebookTask1 book, Scanner input) {
